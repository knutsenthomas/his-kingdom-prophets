...
const assetDefinitions = [
  ...
  // Bibelkalkulator & Vurderingsverktøy (Grades Calculator Page)
  { slug: 'teacher-grading-breadcrumb', title: 'Kalkulator: Brødsmule', section: 'Mentorportal', type: 'text', description: 'Tilbake-lenke til dashboardet.' },
  { slug: 'teacher-grading-title', title: 'Kalkulator: Hovedtittel', section: 'Mentorportal', type: 'text', description: 'Hovedoverskrift øverst på siden.' },
  { slug: 'teacher-grading-desc', title: 'Kalkulator: Beskrivelse', section: 'Mentorportal', type: 'textarea', description: 'Forklarende introduksjonstekst under tittelen.' },
  { slug: 'teacher-grading-select-student', title: 'Kalkulator: Velg disippel', section: 'Mentorportal', type: 'text', description: 'Tittel for disippelvalg-kortet.' },
  { slug: 'teacher-grading-weights-title', title: 'Kalkulator: Studieplanvekting', section: 'Mentorportal', type: 'text', description: 'Overskrift for vekting-seksjonen.' },
  { slug: 'teacher-grading-weight-quiz', title: 'Kalkulator: Vekting quizer', section: 'Mentorportal', type: 'text', description: 'Navn på quiz-vekting slider.' },
  { slug: 'teacher-grading-weight-assignment', title: 'Kalkulator: Vekting tjenesteoppgave', section: 'Mentorportal', type: 'text', description: 'Navn på tjenesteoppgave-vekting slider.' },
  { slug: 'teacher-grading-weight-exam', title: 'Kalkulator: Vekting semesteroppgave', section: 'Mentorportal', type: 'text', description: 'Navn på semesteroppgave-vekting slider.' },
  { slug: 'teacher-grading-scores-title', title: 'Kalkulator: Poengsummer tittel', section: 'Mentorportal', type: 'text', description: 'Overskrift for poengsum-inntastingen.' },
  { slug: 'teacher-grading-score-quiz', title: 'Kalkulator: Poeng quizer', section: 'Mentorportal', type: 'text', description: 'Label for quiz-poengsum.' },
  { slug: 'teacher-grading-score-assignment', title: 'Kalkulator: Poeng tjenesteoppgaver', section: 'Mentorportal', type: 'text', description: 'Label for tjenesteoppgave-poengsum.' },
  { slug: 'teacher-grading-score-exam', title: 'Kalkulator: Poeng semesteroppgave', section: 'Mentorportal', type: 'text', description: 'Label for semesteroppgave-poengsum.' },
  { slug: 'teacher-grading-summary-title', title: 'Kalkulator: Resymé tittel', section: 'Mentorportal', type: 'text', description: 'Hovedetikett for karakterhjulet.' },
  { slug: 'teacher-grading-summary-recipient', title: 'Kalkulator: Resymé mottaker', section: 'Mentorportal', type: 'text', description: 'Label for mottaker-linjen.' },
  { slug: 'teacher-grading-summary-course', title: 'Kalkulator: Resymé kurs', section: 'Mentorportal', type: 'text', description: 'Label for kurs-linjen.' },
  { slug: 'teacher-grading-summary-progress', title: 'Kalkulator: Resymé fremdrift', section: 'Mentorportal', type: 'text', description: 'Label for fremdrifts-linjen.' },
  { slug: 'teacher-grading-summary-btn', title: 'Kalkulator: Resymé lagreknapp', section: 'Mentorportal', type: 'text', description: 'Tekst på den store lilla lagre-evalueringsknappen.' },
  { slug: 'teacher-grading-assignments-title', title: 'Kalkulator: Oppgaver tittel', section: 'Mentorportal', type: 'text', description: 'Tittel for oppgavelisten nederst.' },
  { slug: 'teacher-grading-assignments-desc', title: 'Kalkulator: Oppgaver beskrivelse', section: 'Mentorportal', type: 'textarea', description: 'Hjelpetekst under oppgaver-tittelen.' },
  { slug: 'teacher-grading-tab-pending', title: 'Kalkulator: Fane Utestående', section: 'Mentorportal', type: 'text', description: 'Fane-etikett for ubehandlede oppgaver.' },
  { slug: 'teacher-grading-tab-submitted', title: 'Kalkulator: Fane Innsendt', section: 'Mentorportal', type: 'text', description: 'Fane-etikett for innleverte oppgaver.' },
  { slug: 'teacher-grading-tab-graded', title: 'Kalkulator: Fane Vurdert', section: 'Mentorportal', type: 'text', description: 'Fane-etikett for fullførte vurderinger.' },
  { slug: 'teacher-grading-status-pending', title: 'Kalkulator: Status Ikke innlevert', section: 'Mentorportal', type: 'text', description: 'Status-etikett på oppgavekort.' },
  { slug: 'teacher-grading-status-submitted', title: 'Kalkulator: Status Innsendt', section: 'Mentorportal', type: 'text', description: 'Status-etikett på oppgavekort.' },
  { slug: 'teacher-grading-status-graded', title: 'Kalkulator: Status Vurdert', section: 'Mentorportal', type: 'text', description: 'Status-etikett på oppgavekort.' },
  { slug: 'teacher-grading-no-assignments', title: 'Kalkulator: Ingen oppgaver beskjed', section: 'Mentorportal', type: 'text', description: 'Tekst som vises når en oppgave-tab er tom.' },
  { slug: 'teacher-grading-classroom', title: 'Kalkulator: Merkelapp Klasserom', section: 'Mentorportal', type: 'text', description: 'Klasserom-kilde tagg på oppgavekort.' },
  { slug: 'teacher-grading-deadline-label', title: 'Kalkulator: Frist merkelapp', section: 'Mentorportal', type: 'text', description: 'Frist-ledetekst på oppgavekort.' },
  { slug: 'teacher-grading-time-label', title: 'Kalkulator: Klokkeslett merkelapp', section: 'Mentorportal', type: 'text', description: 'Kl.-ledetekst på oppgavekort.' },
  { slug: 'teacher-grading-submission-title', title: 'Kalkulator: Elevinnlevering tittel', section: 'Mentorportal', type: 'text', description: 'Overskrift for elevs besvarelseskort.' },
  { slug: 'teacher-grading-submission-student', title: 'Kalkulator: Elev-label', section: 'Mentorportal', type: 'text', description: 'Label for elev-navn felt.' },
  { slug: 'teacher-grading-submission-received', title: 'Kalkulator: Mottatt-label', section: 'Mentorportal', type: 'text', description: 'Label for innsendelsestidspunkt.' },
  { slug: 'teacher-grading-no-text', title: 'Kalkulator: Ingen tekst melding', section: 'Mentorportal', type: 'text', description: 'Melding hvis det ikke er levert fritekst.' },
  { slug: 'teacher-grading-not-delivered', title: 'Kalkulator: Ikke levert ennå melding', section: 'Mentorportal', type: 'text', description: 'Melding hvis oppgaven ikke er levert.' },
  { slug: 'teacher-grading-result-label', title: 'Kalkulator: Resultat feltlabel', section: 'Mentorportal', type: 'text', description: 'Overskrift over bestått/ikke bestått dropdown.' },
  { slug: 'teacher-grading-score-label', title: 'Kalkulator: Poengsum feltlabel', section: 'Mentorportal', type: 'text', description: 'Overskrift over poengsum input.' },
  { slug: 'teacher-grading-feedback-label', title: 'Kalkulator: Tilbakemelding feltlabel', section: 'Mentorportal', type: 'text', description: 'Overskrift over tilbakemelding textarea.' },
  { slug: 'teacher-grading-save-btn', title: 'Kalkulator: Lagre vurdering knapp', section: 'Mentorportal', type: 'text', description: 'Tekst på lagre-tilbakemelding knappen.' },
  { slug: 'teacher-grading-select-prompt', title: 'Kalkulator: Velg oppgave melding', section: 'Mentorportal', type: 'text', description: 'Hjelpetekst når ingen oppgave er valgt.' }
];

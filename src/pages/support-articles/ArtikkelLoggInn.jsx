  ...
  return (
    <SupportArticleLayout
      ...
      relatedArticles={[
        ...
        { title: 'Bruk av Bibelkalkulatoren', href: '/support/artikkel-bibelkalkulator', meta: 'Lest av 920 brukere' },
        { title: 'Feilsøking ved Zoom-strømmer', href: '/support/artikkel-zoom', meta: 'Lest av 650 brukere' }
      ]}
      cta={
